...
export default function AddTechnique() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!file || !title) {
      alert('Please add a GIF or video and title')
      return
    }
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              type="file"
              accept="image/gif,video/mp4,video/webm,video/quicktime,video/x-m4v,.gif,.mp4,.webm,.mov,.m4v"
            ...
            <p className="mt-2 text-sm text-gray-500">
              MP4 or WebM is recommended for faster loading. Maximum 100 MB.
            </p>
          </div>
